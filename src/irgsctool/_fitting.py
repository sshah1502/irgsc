    ...
    """
        if use_optimal_method is True:
            ...
            model_params_k0 = Models.select_sam(teff_range=[4000,10000],\
                                                         logg_range=None, feh_range=None, use_sam = 'Kurucz', use_optimal_method=True)            
            model_params_c1 = Models.select_sam(teff_range=[2800,5000],\
                                                          logg_range=[3.0,5.5], feh_range=[-5.0,-1.5],  use_sam = 'Phoenix', use_optimal_method=True)
            model_params_c2 = Models.select_sam(teff_range=[2800,4000],\
                                                          logg_range=[0.0,3.0], feh_range=[-0.5,1.5],  use_sam = 'Phoenix', use_optimal_method=True)
            ...
            observed_colours = (ec_gmag - ec_rmag), (ec_gmag - ec_imag), (ec_gmag - ec_rmag),\
                (ec_gmag - ec_ymag), (ec_rmag - ec_imag), (ec_rmag - ec_ymag), (ec_rmag - ec_zmag),\
                    (ec_imag - ec_zmag), (ec_imag - ec_ymag), (ec_zmag - ec_ymag)
